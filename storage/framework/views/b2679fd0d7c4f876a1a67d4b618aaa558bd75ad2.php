        	...
        	<div id="form_perfil_registro">
				...
				<form class="form">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label for="txtCarrera">Año de inicio</label>
								<select name="lstAnioInicio" id="lstAnioInicio" class="form-control">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="txtCarrera">Año de fin o esperado</label>
								<select name="lstAnioFin" id="lstAnioFin" class="form-control">
									<option value="">[AÑO]</option>
									<option value="2015">2015</option>
									<option value="2016">2016</option>
									<option value="2017">2017</option>
