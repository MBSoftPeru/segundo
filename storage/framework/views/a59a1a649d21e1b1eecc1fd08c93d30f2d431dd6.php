					...
					<div class="create-acount">
						<div class="panel panel-default">
							...
							<div class="panel-footer">
								<div class="form-group botonera">
									<a href="<?php echo e(route('registro.social', 'facebook')); ?>" class="btn btn-default margin btnNootas btnLoginFacebook btnSocial"> <span></span> INGRESA CON FACEBOOK</a>
									<a href="<?php echo e(route('registro.social', 'google')); ?>" class="btn btn-default margin btnNootas btnLoginGoogle btnSocial"> <span></span> INGRESA CON GOOGLE</a>
								</div>
